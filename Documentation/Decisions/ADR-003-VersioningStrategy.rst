...
As of July 2026, nine consumer repositories SHA-pin ``reusable-backport.yml``,
and their pins have already drifted across two different commits — most
consumers silently miss the latest workflow fixes. The open migration PRs use
``@main``. A clear strategy is needed for consistency.
